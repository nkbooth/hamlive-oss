...
class ThemeToggle extends HTMLElement {
    toggleRoot = this.attachShadow({ mode: 'closed' });
    get effectiveTheme() {
    ...
    renderIcon() {
        ...
        if (button) {
            ...
            button.setAttribute('aria-label', this.effectiveTheme === 'dark' ? 'Switch to light mode' : 'Switch to dark mode');
        }
    }
    connectedCallback() {
        this.toggleRoot.innerHTML = `
            <style>
                button {
